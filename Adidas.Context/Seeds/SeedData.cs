...
namespace Adidas.Context.Seeds
{
    public static class SeedData
    {
        ...
        {
            // Admin User for AddedById
            // var adminUserId = "aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaa000";
            ...
            // ✅ Admin User Seed
            var adminUserId = "aaaaaaaa-1111-2222-3333-444444444444";
            ...
            for (int i = 1; i <= 50; i++)
            {
                ...
                users.Add(new User
                {
                    Id = $"bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbb00{i:D2}",
            ...
            //    {
            //        Id = Guid.Parse($"cccccccc-cccc-cccc-cccc-cccccccc00{i:D2}"),
            ...
            //    {
            //        Id = Guid.Parse($"dddddddd-dddd-dddd-dddd-dddddddd00{i:D2}"),
            //        Name = $"{categoryNames[i % categoryNames.Length]}{(i >= categoryNames.Length ? $" {(i / categoryNames.Length) + 1}" : "")}",
            //        Slug = $"{categoryNames[i % categoryNames.Length].ToLower()}-{i + 1}",
            ...
            //    {
            //        Id = Guid.Parse($"eeeeeeee-eeee-eeee-eeee-eeeeeeee00{i:D2}"),
            ...
            //    {
            //        Id = Guid.Parse($"ffffffff-ffff-ffff-ffff-ffffffff00{i:D2}"),
            //        Name = $"Adidas {productNames[i % productNames.Length]}{(i >= productNames.Length ? $" {(i / productNames.Length) + 1}" : "")}",
            //        Description = $"Experience the perfect blend of comfort and style with the {productNames[i % productNames.Length]}. " +
            //                    "Featuring premium materials and innovative technology for exceptional performance.",
            ...
            //    {
            //        Id = Guid.Parse($"gggggggg-gggg-gggg-gggg-gggggggg00{i:D2}"),
            ...
            //    {
            //        Id = Guid.Parse($"hhhhhhhh-hhhh-hhhh-hhhh-hhhhhhhh00{i:D2}"),
            ...
            //    {
            //        Id = Guid.Parse($"iiiiiiii-iiii-iiii-iiii-iiiiiiii00{i:D2}"),
            ...
            //    {
            //        Id = Guid.Parse($"jjjjjjjj-jjjj-jjjj-jjjj-jjjjjjjj00{i:D2}"),
            ...
            //    {
            //        Id = Guid.Parse($"kkkkkkkk-kkkk-kkkk-kkkk-kkkkkkkk00{i:D2}"),
            ...
            //    {
            //        Id = Guid.Parse($"llllllll-llll-llll-llll-llllllll00{i:D2}"),
            ...
            //        Notes = i % 3 == 0 ? $"Special delivery instructions for order {i + 1}" : null,
            //        UserId = users[i % users.Count].Id,
            //        IsDeleted = false,
            //        IsActive = true,
            //        CreatedAt = orderDate,
            ...
            //    {
            //        Id = Guid.Parse($"mmmmmmmm-mmmm-mmmm-mmmm-mmmmmmmm00{i:D2}"),
            //        Quantity = quantity,
            //        UnitPrice = unitPrice,
            ...
            //    {
            //        Id = Guid.Parse($"nnnnnnnn-nnnn-nnnn-nnnn-nnnnnnnn00{i:D2}"),
            ...
            //    {
            //        Id = Guid.Parse($"oooooooo-oooo-oooo-oooo-oooooooo00{i:D2}"),
            ...
            //    {
            //        Id = Guid.Parse($"pppppppp-pppp-pppp-pppp-pppppppp00{i:D2}"),
            ...
            //    {
            //        Id = Guid.Parse($"qqqqqqqq-qqqq-qqqq-qqqq-qqqqqqqq00{i:D2}"),
            ...
            //    {
            //        Id = Guid.Parse($"rrrrrrrr-rrrr-rrrr-rrrr-rrrrrrrr00{i:D2}"),
            //        AddedAt = addedDate,
            //        UserId = users[i % users.Count].Id,
            //        ProductId = products[i % products.Count].Id,
            //        IsDeleted = false,
            ...
            //    {
            //        Id = Guid.Parse($"ssssssss-ssss-ssss-ssss-ssssssss00{i:D2}"),
            //        ChangeType = changeTypes[i % changeTypes.Length],
            //        VariantId = productVariants[i % productVariants.Count].Id,
            //        QuantityChange = (i % 5) + 1,
            //        NewStock = (i % 5) + 1,
            //        PreviousStock = (i % 5) + 1,
