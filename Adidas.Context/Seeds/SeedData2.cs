...
namespace Adidas.Context.Seeds
{
    public static class SeedData2
    {
        public static void Seed(ModelBuilder modelBuilder)
        {
            ...
            //        Id = makeId(index++),
            //        Name = sub,
            //        Slug = sub.ToLower().Replace(" ", "-").Replace("&", "and") + "-womens",
            ...
            //        Id = makeId(index++),
            //        Name = sub,
            //        Slug = sub.ToLower().Replace(" ", "-") + "-womens",
            //        Description = $"Women’s {sub.ToLower()} collection.",
            ...
            //        Id = makeId(index++),
            //        Name = sub,
            //        Slug = sub.ToLower().Replace(" ", "-") + "-kids4to8",
            ...
            //        Id = makeId(index++),
            //        Name = sub,
            //        Slug = sub.ToLower().Replace(" ", "-") + "-football",
            ...
            //        Id = makeId(index++),
            //        Name = sub,
            //        Slug = sub.ToLower().Replace(" ", "-") + "-outdoor",
            ...
            //        Id = makeId(index++),
            //        Name = sub,
            //        Slug = sub.ToLower().Replace(" ", "-") + "-running",
